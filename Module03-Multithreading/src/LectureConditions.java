...
public class LectureConditions {
    ...
    public static class TransferQueue<T> {
        ...
        public void put(T value) throws InterruptedException {
            ...
            try {
                while (size == items.length) {
                    System.out.println("Queue is full. " + Thread.currentThread().getName() + " started to wait...");
                    full.await();
                }
        ...
        public T take() throws InterruptedException {
            ...
            try {
                while (size == 0) {
                    System.out.println("Queue is empty. " + Thread.currentThread().getName() + " started to wait...");
                    empty.await();
                }
